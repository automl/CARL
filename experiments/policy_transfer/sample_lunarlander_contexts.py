...
if __name__ == "__main__":
    ...
    n_contexts = 100
    contexts = get_train_contexts_ll_exp1(
        n_contexts=n_contexts, env_default_context=env_defaults
    )
    contexts = get_train_contexts_ll(
        gravities=gravities,
        context_feature_key="GRAVITY_Y",
        n_contexts=n_contexts,
        env_default_context=env_defaults,
    )
