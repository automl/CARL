...
from rl_baselines_zoo.utils.utils import get_wrapper_class, linear_schedule
from rl_baselines_zoo.utils.exp_manager import ExperimentManager
from typing import Any, Dict

def preprocess_hyperparams(hyperparams: Dict[str, Any]):
    # Convert schedule strings to objects
    hyperparams = ExperimentManager.preprocess_schedules(hyperparams)
