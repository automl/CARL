...
for env_name, df in zip(env_names, dfs):
    ...
    table_str = table_str.replace(r"\begin{subtable}", r"\begin{subtable}{0.4\textwidth}")
    # print(table_str)
...
if calc_new:
    ...
    # hide_context = True
    state_space_sizes = [(2,),  (3,), (6,), (4,), (2,), (8,), (96, 96, 3), (24,), (87,), (23,), (299,), (101,), (132,), (66,)]  #, (11,), (64, 64, 3)]

    action_space_sizes = [(3,), (1,), (3,), (2,), (1,), (4,), (3,), (4,), (8,), (6,), (17,), (10,), (19,), (6,)]
...
for ax, env_type in zip(axs.flat, env_types):
    ...
    xticklabels = ["state_space_size", "action_space_size", "n_context_features"]
    plot_data = D[xticklabels].to_numpy()
    xticklabels = ["state space size", "action space size", "$n_{context\,features}$"]
    ...
    for i, (d, color) in enumerate(zip(plot_data, colors)):
        ...
        ax.set_varlabels(xticklabels)
    # ax.legend(loc=(0.25, -.5), labelspacing=0.1, fontsize='small')
    rticks = np.linspace(0, np.amax(plot_data), 5)
