    ...
    def get_context_features() -> dict[str, ContextFeature]:
        return {
            ...
            "mass_cart": UniformFloatContextFeature(
                "mass_cart", lower=1e-4, upper=np.inf, default_value=1
            ),
            "mass_pole": UniformFloatContextFeature(
                "mass_pole", lower=1e-4, upper=np.inf, default_value=1
            ),
            "mass_pole2": UniformFloatContextFeature(
                "mass_pole2", lower=1e-4, upper=np.inf, default_value=4.1987386
            ),
