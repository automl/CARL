# -*- coding: utf-8 -*-
#
# SMAC3 documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../carl'))
sys.path.insert(0, os.path.abspath('..'))
...
autoapi_type = 'python'
autoapi_dirs = ["../carl/envs"]
autoapi_ignore = ["../carl/envs/learna/carl", "../carl/envs/mario/sprites", "../carl/envs/mario/models", "../carl/envs/mario/Mario-AI-Framework", "../carl/envs/mario/TOAD-GUI"]
...
project = u'CARL Documentation'
copyright = '2021-%s, %s' % (datetime.datetime.now().year, carl.__author__)
author = carl.__author__
...
version = carl.__version__
# The full version, including alpha/beta/rc tags.
release = carl.__version__
...
# man_pages = [
# (master_doc, 'carl', u'CARL Documentation',
# [author], 1)
# ]
...
# import carl.utils.doc_building.build_env_overview_table
# carl.utils.doc_building.build.build()
