...
echo "-----------------------------------------"
python experiments/evaluation/run_evaluation.py '+experiments=context_efficiency' contexts_path=${contexts_path} folder_id=${env_name}/eval/on_test  --result_dir ./runs/context_efficiency/${env_name}/train -m
