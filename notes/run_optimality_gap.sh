...
echo "-----------------------------------------"
python experiments/evaluation/run_evaluation.py '+experiments=optimality_gap' folder_id=${env_name}/eval_general  --result_dir ./runs/optimality_gap/${env_name}/train_general
...
echo "-----------------------------------------"
python experiments/evaluation/run_evaluation.py '+experiments=optimality_gap' folder_id=${env_name}/eval_oracle  --result_dir ./runs/optimality_gap/${env_name}/train_oracle
